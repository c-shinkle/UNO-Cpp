...
void Game::Init()
{
    ...
    ResourceManager::LoadTexture("../../../../unoLib/rsrc/particle.png", true, "particle");
    ResourceManager::LoadTexture("../../../../unoLib/rsrc/powerup_speed.png", true, "powerup_speed");
    ResourceManager::LoadTexture("../../../../unoLib/rsrc/powerup_sticky.png", true, "powerup_sticky");
    ResourceManager::LoadTexture("../../../../unoLib/rsrc/powerup_increase.png", true, "powerup_increase");
    ResourceManager::LoadTexture("../../../../unoLib/rsrc/powerup_confuse.png", true, "powerup_confuse");
    ResourceManager::LoadTexture("../../../../unoLib/rsrc/powerup_chaos.png", true, "powerup_chaos");
    ResourceManager::LoadTexture("../../../../unoLib/rsrc/powerup_passthrough.png", true, "powerup_passthrough");
...
{
    if (this->Level == 0)
        this->Levels[0].Load("../../../../unoLib/rsrc/one.lvl", this->Width, this->Height / 2);
    else if (this->Level == 1)
        this->Levels[1].Load("../../../../unoLib/rsrc/two.lvl", this->Width, this->Height / 2);
